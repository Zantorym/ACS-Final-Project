...
sudo aws s3 cp s3://dev-s3-acsgroup13/images/Jass.jpeg /var/www/html
sudo aws s3 cp s3://dev-s3-acsgroup13/images/jaishreej.jpeg /var/www/html
sudo aws s3 cp s3://dev-s3-acsgroup13/images/harsh.jpeg /var/www/html
sudo aws s3 cp s3://dev-s3-acsgroup13/images/neil.jpeg /var/www/html
...
<body>
<h1>Welcome to Group 13 ACS Project! My private IP is $myip</h1> <section class="team text-center py-5">
   <div class="container">
